          ...
          <div className="relative flex gap-4 items-center justify-between">
            ...
            <Link href="/" className="flex items-center pointer-events-auto">
              <div className="h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10">
                <Image
                  src="/Ammar Yasir.jpeg" // Replace with your logo image
                  alt="Logo"
                  width={50}
                  height={50}
            ...
            <div className="flex flex-1 justify-end md:justify-center">
              ...
              <nav className="pointer-events-auto hidden md:block">
                <Menu>
                  ...
                  <button onClick={() => scrollToSection('cta')} className="hover:text-primary transition-colors duration-200 px-4 py-2 rounded-md">Contact</button>
                </Menu>
              </nav>
        ...
        <div className="fixed inset-x-4 top-20 z-50 origin-top rounded-3xl bg-white p-8 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-900 dark:ring-zinc-800">
          ...
          <nav className="mt-6">
            <ul className="text-base text-zinc-800 dark:text-zinc-300">
              ...
              <li>
                <button onClick={() => scrollToSection('cta')} className="block py-2 hover:text-primary transition-colors duration-200">Contact</button>
              </li>
            </ul>
          </nav>
        </div>
